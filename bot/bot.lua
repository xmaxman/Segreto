...
function pre_process_msg(msg)
  for name,plugin in pairs(plugins) do
    if plugin.pre_process and msg then
		...
		--Man Ino Disable Krdm Age Khasti Khodet Enable Kn (Cmd Ke Mizni Mige Ch Cmdie Zdi Va To Che Pluginie :|)
